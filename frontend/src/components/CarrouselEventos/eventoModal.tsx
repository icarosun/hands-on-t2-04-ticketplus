...
export default function Evento(props: {
  ...
  place: string | number | boolean | React.ReactElement<any, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | null | undefined;
}) {
            ...
            <Card.Body>
              ...
              <Card.Text>
                <small className="text-body-secondary">
                  <Badge bg="secondary">
                    {/* Se necessário, adicione ícones e estilos conforme a sua necessidade */}
                    <FontAwesomeIcon className="text-white me-2" icon={faMapPin} />
                    {props.place}
                  </Badge>
                </small>
              </Card.Text>
