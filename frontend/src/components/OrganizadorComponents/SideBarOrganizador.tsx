...
export default function SidebarOranizador(props: SideBarOrganizadorProps) {
    ...
    return (
        ...
        >
            ...
            <Input size="sm" startDecorator={<SearchRoundedIcon />} placeholder="Pesquisar Evento" />
            <Box
                sx={{
                    minHeight: 0,
            ...
            >
                ...
                >
                    ...
                    <ListItem nested>
                        ...
                        >
                            <List sx={{ gap: 0.5 }}>
                                <ListItem sx={{ mt: 0.5 }}>
                                    <ListItemButton>Geral</ListItemButton>
                                </ListItem>
                                <ListItem>
                                    <ListItemButton>Por Evento</ListItemButton>
                                </ListItem>
                            </List>
                        </Toggler>
                    </ListItem>
                ...
                >
                    ...
                    <Typography level="body-sm">
                        Gratuito, tenha acesso a diversas funcionalidades e com atualizações em tempo real
                    </Typography>
            ...
            <Box sx={{ display: 'flex', gap: 1, alignItems: 'center' }}>
                ...
                <IconButton size="sm" variant="plain" color="neutral" onClick={doLogout}>
                    <LogoutRoundedIcon />
                </IconButton>
            </Box>
        </Sheet>
