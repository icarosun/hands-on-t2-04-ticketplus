...
SELECT b.id as id, b.titulo as evento, b.organizadorId as organizador, a.quantidade as disponivel, c.descricao as tipo_ticket, d.created_at as data, IFNULL(SUM(d.quantidade),0) as vendidos, (a.quantidade-IFNULL(SUM(d.quantidade),0)) as restante 
